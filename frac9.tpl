...
class Ranks
{
	static public function Rank($rank)
    {
		switch($rank)
		{
			case 1: $rank = "Кадет"; break;
            case 2: $rank = "Офицер"; break;
            case 3: $rank = "Мл.Сержант"; break;
            case 4: $rank = "Сержант"; break;
            case 5: $rank = "Ст. Сержант"; break;
            case 6: $rank = "Мл. Прапорщик"; break;
            case 7: $rank = "Прапорщик"; break;
            case 8: $rank = "Ст. Прапорщик"; break;
            case 9: $rank = "Мл. Лейтенант"; break;
            case 10: $rank = "Лейтенант"; break;
            case 11: $rank = "Ст. Лейтенант"; break;
            case 12: $rank = "Капитан"; break;
            case 13: $rank = "Майор"; break;
            case 14: $rank = "Подполковник"; break;
            case 15: $rank = "Полковник"; break;
            case 16: $rank = "Шериф"; break;
            case 17: $rank = "Министр"; break;
			default: return false;
		}
		return $rank;
    }
}
$sql = mysql_query("SELECT `nickname`, `fraction`, `level`, `rank` FROM `accounts` WHERE `fraction` = '9'");
$messages1 = "";
...
unset($sql);
unset($res);
$sql1 = mysql_query("SELECT `nickname`, `fraction`, `rank` FROM `accounts` WHERE `fraction` = '9' and `rank` = '17'");
...
$sql2 = mysql_query("SELECT `nickname`, `fraction`, `rank` FROM `accounts` WHERE `fraction` = '9' and `rank` = '16'");
