...
class Ranks
{
	static public function Rank($rank)
    {
		switch($rank)
		{
			case 1: $rank = "Интерн"; break;
            case 2: $rank = "Участковый врач"; break;
            case 3: $rank = "Терапевт"; break;
            case 4: $rank = "Проктолог"; break;
            case 5: $rank = "Окулист"; break;
            case 6: $rank = "Хирург"; break;
            case 7: $rank = "Зав. отделением"; break;
            case 8: $rank = "Зам. Главврача"; break;
            case 9: $rank = "Главврач"; break;
            case 10: $rank = "Министр"; break;
			default: return false;
		}
		return $rank;
    }
}
$sql = mysql_query("SELECT `nickname`, `fraction`, `level`, `rank` FROM `accounts` WHERE `fraction` = '2'");
$messages1 = "";
...
unset($sql);
unset($res);
$sql1 = mysql_query("SELECT `nickname`, `fraction`, `rank` FROM `accounts` WHERE `fraction` = '2' and `rank` = '10'");
...
$sql2 = mysql_query("SELECT `nickname`, `fraction`, `rank` FROM `accounts` WHERE `fraction` = '2' and `rank` = '9'");
